...
const ReservationStations&      Thread::getRS()      const { return rs; }       // const & para evitar cópia
const UnidadesFuncionais&       Thread::getUF()      const { return uf; }       // const & para evitar cópia
const std::vector<LinhaTabela>& Thread::getTabela()  const { return tabela_de_instrucoes; } // const & para evitar cópia
// Códigos grandes:
